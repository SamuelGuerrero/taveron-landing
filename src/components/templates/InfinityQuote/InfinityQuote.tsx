...
export const InfinityQuote = () => {
  return (
    <section className="relative h-109.25 w-full overflow-hidden bg-black text-white">
      ...
      <p className="absolute top-1/2 left-1/2 w-228.75 -translate-x-1/2 -translate-y-1/2 text-center font-serif text-[64px] leading-[89px] font-semibold text-white italic">
